package org.openjweb.cms.lucene;
...
public class ChineseIndexer {
    ...
    public void index(String indexDir) throws Exception {
        ...
        for(int i = 0; i < ids.length; i++) {
            ...
            /*doc.add(new Field("clsName", clsName, Field.Store.YES, Field.Index.NOT_ANALYZED));
            ...
            doc.add(new Field("comId", comId, Field.Store.YES, Field.Index.NOT_ANALYZED));*/
    ...
    public    void  delIndex(String clsName, String rowId, String dbService, IndexWriter writer, HttpServletRequest request) throws  Exception  {

        Query query = new TermQuery(new Term("fileName","springmvc"));
        this.getWriter().deleteDocuments(query);
